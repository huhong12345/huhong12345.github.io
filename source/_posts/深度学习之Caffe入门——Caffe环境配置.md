...
- Caffe
---
2016年11月，经历了数模校赛，培训，国赛等一系列折磨后，最终拿到了个不好不坏的成绩：国二。说不甘心肯定是有的，但当时觉得数模也就那么回事，便申请负责了一个国创项目，间接进入导师实验室开始做科研训练。当时成绩还不错，又有很多竞赛，进了学习一个很不错的组。也是第一次和DL开始结缘。。。当然，那时候第一次看paper还是蛮难的，第一次接触“深度学习”这个词，被它各种玄幻但又挺符合常理的操作所折服。便一直做下去了。
